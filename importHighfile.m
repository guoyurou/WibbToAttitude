function high_c = importHighfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   HIGH_C = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   HIGH_C = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   high_c = importfile('high.txt', 1, 60000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/29 16:25:37
...
high_c = dataset(dataArray{1:end-1}, 'VarNames', {'time','VarName2','h'});
