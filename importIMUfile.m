function imuENU = importIMUfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   IMUENU = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   IMUENU = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   imuENU = importfile('imu_ENU.txt', 1, 60000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/03/10 11:16:52
...
imuENU = dataset(dataArray{1:end-1}, 'VarNames', {'time','fbx','fby','fbz','wibbx','wibby','wibbz'});
